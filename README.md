...
```
 git clone https://github.com/mariapilan/exercicios-api.git
```
...
```
## Insomnia
[![Run in Insomnia}](https://insomnia.rest/images/run.svg)](https://insomnia.rest/run/?label=exercicios-api&uri=https%3A%2F%2Fraw.githubusercontent.com%2Fmariapilan%2Fexercicios-api%2Fmain%2FInsomnia.json)
