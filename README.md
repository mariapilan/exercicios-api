...
```
 git clone https://github.com/MariaLuizaAdame33/exercicios-api.git
```
...
```
## Insomnia
[![Run in Insomnia}](https://insomnia.rest/images/run.svg)](https://insomnia.rest/run/?label=Exercicios%20API&uri=https%3A%2F%2Fraw.githubusercontent.com%2FMariaLuizaAdame33%2Fexercicios-api%2Fmain%2FInsomnia.json)
